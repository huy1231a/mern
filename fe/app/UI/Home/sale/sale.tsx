...
const Sale = () => {
  ...
  return (
    <div className="flex justify-center mt-5">
      <div className="w-[1528px] h-[1000px]">
        ...
        <div className="mt-10">
          ...
          <div className="flex gap-5">
            {data.map((item) => (
              <div className="w-[238px] h-auto rounded-2xl flex flex-col bg-[#FAFAFA]">
                <Image
                  src={item.img}
                  alt=""
                  width={238}
                ...
                <div className="flex flex-col p-4">
                  <h1 className="font-bold text-lg leading-normal text-black">
                    {item.title}
                  </h1>
                  <span className="font-normal text-sm leading-normal text-[#FC8A06]">
                    {item.nameRes}
                  </span>
                </div>
              </div>
